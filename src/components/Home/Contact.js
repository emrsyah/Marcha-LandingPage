  ...
  return (
    <div className="mx-20 my-28 flex bg-purple-600 rounded-2xl">
      <div style={{flexGrow: '3'}} className="flex justify-center flex-col p-8 text-white space-y-4">
        ...
        <button onClick={()=>navigate('/contact')} className="flex items-center gap-1 bg-white max-w-max px-5 py-3 text-purple-600 font-semibold rounded-lg space-x-4 hover:bg-purple-800 hover:text-white transition-all ease-out duration-200">

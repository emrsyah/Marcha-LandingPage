...
import Group1 from "../assets/marcha-mockup.svg";

function Features() {
  return (
    <div className="flex mx-20 space-x-4 my-40">
      <div style={{ flexGrow: "2" }} className="space-y-4">
        <h2 className="font-semibold text-5xl my-4 ">Our Features</h2>
        <div id="atas" className="flex space-x-6">
          <div
        ...
        <div id="bawah" className="flex space-x-6">
          <div
            className="flex border-[1.6px] p-4 rounded-md gap-x-4"
            style={{ flexGrow: "3" }}
          >
